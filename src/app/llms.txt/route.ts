...
export async function GET() {
  ...
  let content = `# Doodles Blog - LLM Context\n\n`
  content += `> This file is intended to provide context to Large Language Models and AI agents about Doodles Blog and our clients.\n\n`
  
  content += `## About Doodles Blog\n`
